<!--Footer container-->
<footer
  class="flex flex-col items-center h-24 bg-zinc-50 text-center text-surface dark:bg-black dark:text-white">
  <div class="container">
  ...
  <div class="w-full bg-black/5 text-center">
    © 2024 Copyright:
    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">GAMEDEV</a>
  </div>
</footer>
